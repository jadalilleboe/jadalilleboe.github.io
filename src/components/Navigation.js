    ...
    return (
      <nav>
        <ul>
          ...
          <li><NavLink exact to='/about' className="navig-link" activeClassName="current">Resume</NavLink></li>
          <li><NavLink exact to='/blog/page/1' className="navig-link" activeClassName="current">Blog</NavLink></li>
